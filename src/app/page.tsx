      ...
      <section id="about" className="bg-white py-10 sm:py-16 px-4 sm:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-base sm:text-2xl md:text-3xl font-light text-gray-800 leading-relaxed">
            ...
            Hence, this page, with the hope that someday it will be big enough to take us anywhere we want to go. <br/>
            Enough of GeeksforGeeks, It is time for GeeksforTrips!
          </p>
            </div>
      </section>
